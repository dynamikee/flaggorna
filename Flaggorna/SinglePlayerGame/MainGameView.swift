    ...
    var body: some View {
        ...
        VStack {
            ...
            if let randomCountry = randomCountry {
                ...
                SceneViewContainer(scene: scene, randomCountry: randomCountry)
...
struct SceneViewContainer: UIViewRepresentable {
    ...
    private func addFlagNode(to scene: SCNScene, randomCountry: Country?) {
        ...
        let flagTexture = UIImage(named: randomCountry.flag)
